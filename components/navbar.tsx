...
export const Navbar = () => {
	...
	return (
      ...
      <Input type="search" size="sm"label="View player's profile"value={inputValue} onInput={handleInputChange} placeholder="Enter username" style={{
width: 500
  }}/>
	  <Button color="success" size="md" radius="md" onClick={handleButtonClick} style={{
		height: 40,
width: 100
  }}>
      SEARCH
