import { SYMBOLS } from "../constants/stats";

export const PET_RARITY_OFFSET = [
    { rarity: "common", value: 0 },
    { rarity: "uncommon", value: 6 },
    { rarity: "rare", value: 11 },
    { rarity: "epic", value: 16 },
...
export const PET_ITEMS = [
    ...
    {
      id: "PET_ITEM_SHARPENED_CLAWS_UNCOMMON",
    ...
    {
      id: "PET_ITEM_HARDENED_SCALES_UNCOMMON",
    ...
    {
      id: "PET_ITEM_FORAGING_SKILL_BOOST_COMMON",
      name: "Foraging Exp Boost",
      tier: "COMMON",
      description: "§7Gives +§a20% §7pet exp for Foraging.",
    },
    {
      id: "PET_ITEM_FORAGING_SKILL_BOOST_UNCOMMON",
      name: "Foraging Exp Boost",
      tier: "UNCOMMON",
      description: "§7Gives +§a30% §7pet exp for Foraging.",
    },
    {
      id: "PET_ITEM_FORAGING_SKILL_BOOST_RARE",
      name: "Foraging Exp Boost",
      tier: "RARE",
    ...
    {
      id: "PET_ITEM_MINING_SKILL_BOOST_COMMON",
    ...
    },
    {
      ...
      },
      {
        ...
        name: "Dead Cat Food",
        tier: "RARE",
        description: `§7Grants §a+30 Rift Time §7and §b5 Mana Regen§7.`,
        stats: {
          rift_time: 30,
          mana_regen: 5,
        },
      ...
      {
        id: "UNCOMMON_PARTY_HAT",
        name: "Uncommon Party Hat",
        tier: "UNCOMMON",
        description: "§7Grants a random §6uncommon §7hat cosmetic.",
      },
      {
        id: "RARE_PARTY_HAT",
        name: "Rare Party Hat",
        tier: "RARE",
        description: "§7Grants a random §bRare §7hat cosmetic.",
      },
      {
        id: "EPIC_PARTY_HAT",
        name: "Epic Party Hat",
        tier: "EPIC",
        description: "§7Grants a random §dEpic §7hat cosmetic.",
      },
      {
        id: "LEGENDARY_PARTY_HAT",
        name: "Legendary Party Hat",
        tier: "LEGENDARY",
        description: "§7Grants a random §6Legendary §7hat cosmetic.",
      },
    ];