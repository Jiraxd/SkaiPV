export const museumConstant = {
    ...
    "Special": [
      ...
      "FARMER_ROD",
      "FARMING_FOR_DUMMIES",
      "FESTIVE_JERRY_PERSONALITY",
      "FESTIVE_SKELETON_PERSONALITY",
      "FESTIVE_ZOMBIE_PERSONALITY",
      "FISH_HAT",
      "FISH_PERSONALITY",
      "SNOWFLAKE_THE_FISH",
      "PET_SKIN_SILVERFISH",
      ...
      "TROPICAL_BIRD_2_PERSONALITY",
      "PET_SKIN_TIGER_TWILIGHT",
      "UNDEAD_PERSONALITY",
      "PET_SKIN_ENDERMAN_SLAYER",
      "DUNGEON_DISC_3",
      "PET_SKIN_GUARDIAN",
      "WHITE_TIGER_PERSONALITY",
